...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    func connectionDidFinishLoading(connection: NSURLConnection)
    {
        do{
            ...
            let myTextGoesHere2 = myTextGoesHere.stringByReplacingOccurrencesOfString(" ", withString: "", options: NSStringCompareOptions.CaseInsensitiveSearch, range: nil)
            
            let myAlert = UIAlertView(title: "iOS RESTful", message: myTextGoesHere2, delegate: nil, cancelButtonTitle: "cancelar")
            myAlert.show()
            /*
            let myTextGoesHere  = NSString(data: self.data, encoding: NSUTF8StringEncoding) as! String
            ...
            */
            ...
            if let jsonResult = try NSJSONSerialization.JSONObjectWithData(data, options: NSJSONReadingOptions.MutableContainers) as? NSDictionary {
               ...
               // var jsonData: NSData = NSJSONSerialization.dataWithJSONObject(self.data, options: NSJSONWritingOptions.PrettyPrinted)
